...
namespace Drupal\umd_sitemap\Form;
 ...
 */
class UmdSitemapSettingsForm extends ConfigFormBase {

  use \Drupal\Core\StringTranslation\StringTranslationTrait;

  const SETTINGS = 'umd_sitemap.settings';

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'umd-sitemap-settings-form';
  }
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    $yaml_fields = ['umd_sitemap_targets'];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($yaml_fields as $yfield) {
      ...
      try {
        ...
        // "validateForm" method.
        $this->logger('umd_sitemap')->error("Error parsing 'Hero Search' YAML: " . $pe);
      }
    }
